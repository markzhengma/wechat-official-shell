        ...
        return (
            <div className = "create-page">
                ...
                {this.state.admin === "ShellHulunbuir" ? 
                    ...
                    //         <option>保养记录</option>
                    //     </select>
                    //     <h3>创建新保养记录（若有新客户请先创建用户后再创建保养记录）</h3>
                    ...
                    <form className = "create-form" onSubmit = {(e) => this.props.handleNewUserSubmit(e, this.state.service_num,
                        ...
                        <h3>欢迎，{this.state.location}管理员</h3>
                        <select name = "isNewUser" onChange = {this.handleInputChange}>
                            <option>新客户</option>
                            <option>老客户</option>
                        </select>
                        <h3>创建新客户</h3>
                    ...
                    <div className = "login-box">
                        ...
                        <select name = "location" onChange = {this.handleInputChange}>
                            ...
                            <option>海拉尔河东店</option>
                            <option>海拉尔河西店</option>
                            <option>满洲里老店</option>
                            <option>满洲里新店</option>
                            <option>牙克石</option>
                        </select>
                ...
                <button onClick = {this.resetLogIn}>返回登录</button>
